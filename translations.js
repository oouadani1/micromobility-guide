window.MICROMOBILITY_TRANSLATIONS = {
  ui: {
    es: {
      ...
      noAdditionalVisibilityRules: "No hubo notas adicionales que cambiaran lo que apareció para estas respuestas.",
      ...
      visibilityRuleOperators: "Algunos sistemas compartidos tienen sus propios requisitos de uso. Por ejemplo, Bluebikes actualmente requiere que quienes usen el servicio tengan 16 años o más.",
      visibilityRulePolicy: "Algunas opciones se muestran con más cautela en esta herramienta para reflejar el enfoque de seguridad del informe, aunque la ley estatal no use exactamente las mismas categorías.",
      ...
      positiveReasonAgeYouth: "La edad seleccionada ayuda a mostrar opciones pensadas para niños y jóvenes.",
      positiveReasonAgeTeen: "La edad seleccionada ayuda a mostrar opciones apropiadas para adolescentes.",
      positiveReasonAgeOlder: "La edad seleccionada ayuda a mostrar opciones más estables y prácticas.",
      positiveReasonAdaptiveNeed: "La necesidad de movilidad seleccionada ayuda a mostrar con más claridad las bicicletas adaptadas y otras opciones de apoyo.",
      positiveReasonTransport: "Usar el dispositivo para ir al trabajo, la escuela o hacer mandados ayuda a mostrar opciones más prácticas para el día a día.",
      positiveReasonDeliveries: "Usar el dispositivo para entregas o trabajo ayuda a mostrar opciones con más capacidad de carga.",
      positiveReasonRecreation: "Usar el dispositivo para recreación o ejercicio ayuda a mostrar opciones pensadas para paseos y actividad física.",
      positiveReasonTransit: "Combinar el viaje con transporte público ayuda a mostrar opciones que funcionan mejor con viajes combinados.",
      positiveReasonChildren: "Llevar niños ayuda a mostrar opciones más aptas para familias, como algunas bicicletas y bicicletas de carga.",
      positiveReasonDistanceUnder3: "Las distancias cortas ayudan a mostrar opciones ligeras y fáciles de usar.",
      positiveReasonDistance3to9: "Las distancias medias ayudan a mostrar bicicletas prácticas para viajes cotidianos y algunas opciones eléctricas.",
      positiveReasonDistance10plus: "Las distancias largas ayudan a mostrar opciones con asistencia eléctrica o mayor alcance.",
      positiveReasonRouteBikeLanes: "Las ciclovías separadas ayudan a mostrar una gama más amplia de opciones para circular.",
      positiveReasonRouteMixedRoads: "Las rutas con algo de tráfico ayudan a mostrar opciones que suelen sentirse más estables y prácticas junto a autos.",
      positiveReasonRouteRegularRoads: "Las rutas sin separación del tráfico ayudan a mostrar opciones más estables y preparadas para la calle.",
      positiveReasonRouteTrails: "Las rutas en senderos o parques ayudan a mostrar opciones adecuadas para ese tipo de recorrido.",
      positiveReasonStorageIndoor: "La necesidad de entrar el dispositivo ayuda a mostrar opciones más fáciles de guardar o plegar.",
      positiveReasonStorageOutdoor: "Guardar el dispositivo afuera ayuda a mostrar opciones más fáciles de estacionar o dejar al exterior.",
